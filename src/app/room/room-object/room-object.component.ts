    ...
    this.objectService.getObject(id).subscribe(
      objects => {
        ...
        if (change) {
          ...
          const compare = function (obj1: OssObject, obj2: OssObject) {
            const val1 = obj1.order;
            const val2 = obj2.order;
            if (val1 < val2) {
              return -1;
            } else if (val1 > val2) {
              return 1;
